        ...
        <div className="flex items-center gap-2">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-64 p-2 rounded-[24px] shadow-2xl border-hairline mt-3 animate-in fade-in zoom-in-95 duration-200">
              <DropdownMenuLabel className="px-3 py-3 text-[10px] font-black text-on-surface-tertiary uppercase tracking-[0.2em]">Cá nhân hóa</DropdownMenuLabel>
              <DropdownMenuItem className="rounded-xl gap-3 cursor-pointer px-3 py-3 focus:bg-surface-tinted focus:text-primary-strong transition-colors">
                <User className="w-4.5 h-4.5" /> <span className="font-bold text-xs uppercase tracking-wider">Hồ sơ chuyên gia</span>
              </DropdownMenuItem>
              <Link href="/settings">
                <DropdownMenuItem className="rounded-xl gap-3 cursor-pointer px-3 py-3 focus:bg-surface-tinted focus:text-primary-strong transition-colors">
                  <Settings className="w-4.5 h-4.5" /> <span className="font-bold text-xs uppercase tracking-wider">Cấu hình hệ thống</span>
                </DropdownMenuItem>
              </Link>
              <DropdownMenuSeparator className="bg-hairline/50 my-2" />
              <DropdownMenuItem className="rounded-xl gap-3 cursor-pointer px-3 py-3 text-red-500 focus:bg-red-50 focus:text-red-600 transition-colors">
                <LogOut className="w-4.5 h-4.5" /> <span className="font-bold text-xs uppercase tracking-wider">Đăng xuất an toàn</span>
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        </div>
